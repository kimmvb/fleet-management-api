...
public class TrajectoryController {
    ...
    public Page<Trajectory> getTaxisLastLocation(
            @Parameter(name = "pageable", description = "Pages description",
                    example = "{\"page\": 0, \"size\": 10, \"sort\": [\"id,asc\"]}")
            Pageable pageable) {
        return trajectoryService.getTaxisLastLocation(pageable);
    }
